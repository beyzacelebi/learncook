...
import Blog from "./Pages/Blog"; // veya doğru dosya yolu ve isim
  ...
  return (
    <div className="bg-white dark:bg-gray-800 text-black dark:text-white min-h-screen transition">
      ...
      <Routes>
        ...
        {/* Blog */}<Route path="/blog/:id" element={<BlogDetail />} />
        {/* Tarif */}<Route path="/recipes/:recipeId" element={<RecipeDetail />} />
